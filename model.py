"""
Fixed CodeLACE Model Implementation
This version fixes the "index out of range" error in the attention mechanism.
"""
...
class SparseAttention(nn.Module):
    """Fixed sparse attention mechanism for code analysis."""
    ...
    def _create_sparse_mask(self, seq_length: int, device: torch.device, batch_size: int) -> torch.Tensor:
        """Create sparse attention mask - FIXED VERSION."""
...
class TokenPooling(nn.Module):
    """Fixed hierarchical token pooling for sequence reduction."""
...
class MixtureOfExperts(nn.Module):
    """Fixed mixture of experts for specialized processing."""
...
class CodeLACELayer(nn.Module):
    """Fixed single CodeLACE transformer layer."""
...
class CodeLACE(nn.Module):
    """Fixed main CodeLACE model for semantic source code analysis."""
